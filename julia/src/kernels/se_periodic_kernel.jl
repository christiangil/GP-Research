...
"""
se_periodic_kernel function created by kernel_coder(). Requires 2 hyperparameters. Likely created using se_periodic_kernel_base() as an input. 
Use with include("src/kernels/se_periodic_kernel.jl").
hyperparameters == ["λ", "se_P"]
"""
function se_periodic_kernel(
...
return se_periodic_kernel, 2  # the function handle and the number of kernel hyperparameters
