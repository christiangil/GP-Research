"""
sex2_kernel function created by kernel_coder(). Requires 3 hyperparameters. Likely created using sex2_kernel_base() as an input.
Use with include("src/kernels/sex2_kernel.jl").
hyperparameters == ["λ1", "λ2", "sratio"]
"""
function sex2_kernel(
...
return sex2_kernel, 3  # the function handle and the number of kernel hyperparameters
