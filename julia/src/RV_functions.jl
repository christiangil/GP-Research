...
function velocity_semi_amplitude(P::Float64, e::Float64, i::Float64, m_star::Float64, m_planet::Float64)
...
function rv(t::Float64, P::Union{Float64, Quantity}, m_star::Union{Float64, Quantity}, m_planet::Union{Float64, Quantity}; e::Float64=0., ω::Float64=0., i::Float64=pi/2, γ::Float64=0.)
    m_star = convert_and_strip_units(u"kg", m_star)
    m_planet = convert_and_strip_units(u"kg", m_planet)
    P = convert_and_strip_units(u"s", P)
    K = velocity_semi_amplitude(P, e, i, m_star, m_planet)
