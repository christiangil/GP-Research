...
function RBF_kernel_base(hyperparameters::Union{Array{Float64,1},Array{Basic,1}}, dif::Union{Basic,Float64})
...
function Periodic_kernel_base(hyperparameters::Union{Array{Float64,1},Array{Basic,1}}, dif::Union{Basic,Float64})
...
function Quasi_periodic_kernel_base(hyperparameters::Union{Array{Float64,1},Array{Basic,1}}, dif::Union{Basic,Float64})
...
function OU_kernel_base(hyperparameters::Union{Array{Float64,1},Array{Basic,1}}, dif::Union{Basic,Float64})
...
function Matern_kernel_base(hyperparameters::Union{Array{Float64,1},Array{Basic,1}}, dif::Union{Basic,Float64}, nu)
...
"Matern 3/2 kernel"
function Matern32_kernel_base(hyperparameters::Union{Array{Float64,1},Array{Basic,1}}, dif::Union{Basic,Float64})
...
"Matern 5/2 kernel"
function Matern52_kernel_base(hyperparameters::Union{Array{Float64,1},Array{Basic,1}}, dif::Union{Basic,Float64})
...
"""
function RQ_kernel_base(hyperparameters::Union{Array{Float64,1},Array{Basic,1}}, dif::Union{Basic,Float64})
...
"""
function Bessel_kernel_base(hyperparameters::Union{Array{Float64,1},Array{Basic,1}}, dif::Union{Basic,Float64}; nu=0)
