...
struct Jones_problem_definition{T1<:Real, T2<:Integer}
    ...
    x_obs::Vector{T} where T<:Unitful.Time # the observation times/phases
	...
	function Jones_problem_definition(
		...
		return Jones_problem_definition(kernel, n_kern_hyper, n_dif, n_out, x_obs, x_obs_units, y_obs, y_obs_units, measurement_noise, normals, a0)
	end
	function Jones_problem_definition(kernel, n_kern_hyper, n_dif, n_out, x_obs, x_obs_units, y_obs, y_obs_units, noise, normals, a0)
		coeff_orders, coeff_coeffs = coefficient_orders(n_out, n_dif, a=a0)
		return Jones_problem_definition(kernel, n_kern_hyper, n_dif, n_out, x_obs, x_obs_units, y_obs, y_obs_units, noise, normals, a0, coeff_orders, coeff_coeffs)
	end
	function Jones_problem_definition(kernel, n_kern_hyper, n_dif, n_out, x_obs, x_obs_units, y_obs, y_obs_units, noise, normals, a0)
		coeff_orders, coeff_coeffs = coefficient_orders(n_out, n_dif, a=a0)
		return Jones_problem_definition(kernel, n_kern_hyper, n_dif, n_out, x_obs, x_obs_units, y_obs, y_obs_units, noise, normals, a0, coeff_orders, coeff_coeffs)
	...
	function Jones_problem_definition(
		...
		return new{typeof(a0[1]), typeof(n_kern_hyper)}(kernel, n_kern_hyper, n_dif, n_out, x_obs, x_obs_units, y_obs, y_obs_units, noise, normals, a0, coeff_orders, coeff_coeffs)
	end
end
