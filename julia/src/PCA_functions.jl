...
function bootstrap_errors(; boot_amount::Integer=10, time_series_spectra::AbstractArray{T,2}=zeros(2,2), hdf5_loc::String="", save_filename::String="jld2_files/bootstrap.jld2") where {T<:Real}
    ...
    fit_normal(a::AbstractArray{T,1}) where {T<:Real} = fit_mle(Normal, a).σ
