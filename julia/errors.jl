...
# @elapsed for k in 1:boot_amount
...
for ind in 1:num_components
    ...
    savefig("figs/errors/PCA_" * string(ind) * "_comparison.pdf")
end
...
test = mapslices(std, Normal, scores_tot[:,:,1 ]; dims=2)
