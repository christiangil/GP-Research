...
temp_prob_def = build_problem_definition(quasi_periodic_kernel, num_kernel_hyperparameters, n_dif, n_out, x_obs, x_obs_units, a0)
...
K_samp = covariance(temp_prob_def, x_obs, x_obs, total_hyperparameters)
...
problem_def_528 = build_problem_definition(quasi_periodic_kernel, num_kernel_hyperparameters, n_dif, n_out, x_obs, x_obs_units, y_obs, "who knows", measurement_noise, a0)
